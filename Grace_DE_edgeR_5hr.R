...
rawdata=read.table("/scratch/user/venura.herath/UPR/RNA_allign/RNA_ALIGN/htseq_counts_clean/gene_read_counts_table_all_5hr_final.tsv", header=TRUE, stringsAsFactors=FALSE, row.names=1)
...
# Save table
write.table(out4, file="DE_genes_5hr.txt", quote=FALSE, row.names=FALSE, sep="\t")
